...
//
    public static List<DataBean> getTestData2() {
        List<DataBean> list = new ArrayList<>();
        list.add(new DataBean(R.drawable.maom, "", 0));
        list.add(new DataBean(R.drawable.mami, "", 1));
...
//        list.add(new DataBean(R.drawable.image11, "生活的态度", 1));
    ...
    public static List<DataBean> getTestData3() {
        List<DataBean> list = new ArrayList<>();
//        list.add(new DataBean(R.drawable.lunbo_jifen, "", 0));
//        list.add(new DataBean(R.drawable.lunbo_zhigu, "", 1));
